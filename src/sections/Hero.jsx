    ...
    >
      ...
      >
        ...
        <p className='text-white text-[20px]'>
          ...
          assumenda alias qui. Sit incidunt error consequatur odio tempore
          aperiam blanditiis
        </p>
        <motion.div
          initial='hidden'
        ...
        >
          <motion.button
            variants={zoomInVariants}
            className='bg-yellow-500 hover:bg-white hover:text-black px-10 py-3 rounded-lg text-black font-bold text-xs sm:text-lg'
          >
            READ MORE
          </motion.button>
          <motion.button
            variants={zoomInVariants}
            className='border-white hover:border-yellow-500 hover:text-yellow-500 border-2 px-10 py-3 rounded-lg text-white font-bold text-xs sm:text-lg'
          >
            REACH US
          </motion.button>
        </motion.div>
